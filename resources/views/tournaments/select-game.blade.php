...
<div class="px-8 py-10 max-w-4xl mx-auto">
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <!-- PUBG -->
        <a href="{{ route('tournaments.create.form', 'PUBG') }}"
           class="group bg-slate-900 border border-slate-700 rounded-3xl p-8
                  hover:border-purple-500 hover:shadow-xl transition">

            <h2 class="text-2xl font-bold mb-2 group-hover:text-purple-400">
                PUBG Mobile
            </h2>
